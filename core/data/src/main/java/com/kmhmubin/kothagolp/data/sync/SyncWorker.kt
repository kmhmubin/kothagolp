...
class SyncWorker(
    ...
    companion object {
        const val UNIQUE_PERIODIC_WORK = "kothagolp_sync_periodic"
        const val UNIQUE_IMMEDIATE_WORK = "kothagolp_sync_immediate"
        const val UNIQUE_TRIGGER_WORK = "kothagolp_sync_triggered"
        const val TAG_SYNC = "kothagolp_sync"
