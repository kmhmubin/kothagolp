...
private fun AppHeaderCard(currentVersion: String) {
    Card(
        ...
        Column(
            ...
            Text(
                text = "Read web novels from anywhere",
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
        ...
        Column(
            ...
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        text = "Check for updates each time the app opens",
                ...
                when {
                    ...
                    hasChecked == true && uiState.updateError != null -> {
                        Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                            Text(
                                text = "Couldn't reach the update server",
                                style = MaterialTheme.typography.bodyMedium,
...
private fun UpdateAvailableContent(
    result: com.kmhmubin.kothagolp.data.update.UpdateChecker.UpdateResult,
    onDownload: (String) -> Unit,
    onViewRelease: (String) -> Unit
) {
...
private fun DisclaimerCard() {
    Card(
        ...
        Column(
            ...
            Text(
                text = "Kothagolp does not host, store, or distribute any content. " +
                        ...
                        "complies with all applicable laws. Use Kothagolp at your own risk.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
