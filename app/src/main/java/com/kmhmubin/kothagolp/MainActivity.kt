...
import com.kmhmubin.kothagolp.service.TTSNotifications
import com.kmhmubin.kothagolp.ui.components.MarkdownText
import com.kmhmubin.kothagolp.ui.components.SplashScreen
import com.kmhmubin.kothagolp.ui.navigation.KothagolpNavGraph
import com.kmhmubin.kothagolp.ui.theme.KothagolpTheme
import com.kmhmubin.kothagolp.util.AppLoadState
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            KothagolpTheme(appSettings = appSettings) {
                Surface(
                        ...
                        if (isSplash) {
                            ...
                            if (showNotificationDialog) {
                                AlertDialog(
                                    ...
                                    text = { Text(text = "Allow notifications to get TTS playback controls and reading timers.") },
                                    confirmButton = {
                                        TextButton(onClick = {
                                            requestNotificationPermission.launch(Manifest.permission.POST_NOTIFICATIONS)
